...
class PromptBertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config, **kwargs):
        ...
        self.config = config
        self.bert = PromptBertModel(config, add_pooling_layer=False)
...
class PromptBertEncoder(BertEncoder):
...
class PromptBertLayer(BertLayer):
    def __init__(self, config):
...
class PromptBertAttention(BertAttention):
    def __init__(self, config, position_embedding_type=None):
        ...
        self.self = PromptBertSelfAttention(config, position_embedding_type=position_embedding_type)
        self.output = BertSelfOutput(config)
        self.pruned_heads = set()

class PromptBertSelfAttention(BertSelfAttention):
    def __init__(self, config, position_embedding_type=None):
