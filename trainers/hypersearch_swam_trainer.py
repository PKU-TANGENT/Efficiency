...
@dataclass
class HyperSWAMTraingArguments(TrainingArguments):
    model_head_lr: Optional[float] = field(
        default=5e-5, 
        metadata={
            "help": "The learning rate for AdamW."
        }
    )
...
class HyperSWAMTrainer(Trainer):
