...
class AdapterTrainer(Trainer):
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            other_decay = [p for n,p in opt_model.named_parameters() if not head_criterion(n) and not adapter_criterion(n) and decay_criterion(n)]
            other_not_decay = [p for n,p in opt_model.named_parameters() if not head_criterion(n) and not adapter_criterion(n) and not decay_criterion(n)]
            ...
            optimizer_cls, optimizer_kwargs = AdapterTrainer.get_optimizer_cls_and_kwargs(self.args)
